...
/// Maps macOS virtual key codes → display names (ANSI layout). Enough for the shortcut recorder UI.
enum KeyCodes {
    ...
    private static let map: [UInt16: String] = [
        ...
        41:";", 42:"\\", 43:",", 44:"/", 45:"N", 46:"M", 47:".", 48:"⇥", 49:"Space", 50:"`",
        51:"⌫", 53:"⎋", 117:"⌦",
        96:"F5", 97:"F6", 98:"F7", 99:"F3", 100:"F8", 101:"F9", 103:"F11", 105:"F13",
        107:"F14", 109:"F10", 111:"F12", 113:"F15", 118:"F4", 120:"F2", 122:"F1",
        116:"⇞", 121:"⇟", 115:"↖", 119:"↘",
        123:"←", 124:"→", 125:"↓", 126:"↑",
    ]
}
